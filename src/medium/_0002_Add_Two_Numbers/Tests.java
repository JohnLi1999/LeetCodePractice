...
class Tests {
    ...
    @Test
    void test1() {
        ListNode l1 = new ListNode().arrayToListNode(new int[] {3, 4, 2});
        ListNode l2 = new ListNode().arrayToListNode(new int[] {4, 6, 5});
        ListNode expectedResult = new ListNode().arrayToListNode(new int[] {8, 0, 7});
    ...
    @Test
    void test2() {
        ListNode l1 = new ListNode().arrayToListNode(new int[] {3, 9, 9, 9});
        ListNode l2 = new ListNode().arrayToListNode(new int[] {4, 1, 1, 1});
        ListNode expectedResult = new ListNode().arrayToListNode(new int[] {8, 1, 1, 0});
    ...
    @Test
    void test3() {
        ListNode l1 = new ListNode().arrayToListNode(new int[] {9, 9, 9, 9});
        ListNode l2 = new ListNode().arrayToListNode(new int[] {1, 1});
        ListNode expectedResult = new ListNode().arrayToListNode(new int[] {1, 0, 0, 1, 0});
